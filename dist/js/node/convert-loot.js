...
const convertLoot = async () => {
    ...
    const getLootItemsFromChestLootTable = (chestLootTableId) => apiItems.filter(item => Number(item.Id) === chestLootTableId).flatMap(item => { var _a; return getLootItems((_a = item.Items) !== null && _a !== void 0 ? _a : []); });
    const data = {};

...
export default class CompareWoods {
    ...
    _initData() {
        ...
        this._setOption(this._frameSelectData.map(wood => `<option value="${wood.id}">${wood.name}</option>`), this._trimSelectData.map(wood => `<option value="${wood.id}">${wood.name}</option>`));

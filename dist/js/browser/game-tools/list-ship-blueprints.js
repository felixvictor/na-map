...
export default class ListShipBlueprints {
    ...
    async _loadAndSetupData() {
        try {
            ...
            this._woodData = (await import("~Lib/gen-generic/woods.json")).default;
    ...
    _updateText() {
        ...
        extraResources.push(["Craft level", this._currentBlueprintData.craftLevel], ["Shipyard level", this._currentBlueprintData.shipyardLevel], ["Labour hours", this._currentBlueprintData.labourHours], ["Craft experience", this._currentBlueprintData.craftXP]);
        const materials = [];

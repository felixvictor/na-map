 ...
 */
class FullMap {
      _PBZoneZoomThreshold: number
      _doubleClickActionId: string
      _doubleClickActionRadios: RadioButton
      _doubleClickActionValues: string[]
      _labelZoomThreshold: number
      _maxScale: number
      _searchParams: URLSearchParams
      _showGridCookie: Cookie
      _showGridId: string
      _showGridRadios: RadioButton
      _showGridValues: string[]
      _tileSize: number
      _wheelDelta: number
    ...
    _currentScale = 0
    _doubleClickActionCookie: Cookie
    coord: MinMaxCoord
    height = 0
    minScale = 0
    rem: number
